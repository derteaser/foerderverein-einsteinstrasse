...
?>
<section class="relative py-20 overflow-hidden bg-blue-100" id="<?= $section->slug() ?>">
  ...
  <div class="relative container px-4 mx-auto z-10">
    <div class="max-w-xl mx-auto lg:mx-0 py-12 pl-16 pr-32 bg-white clip-path-right-top">
      ...
      <a class="flex items-center text-blue-800 text-sm font-bold uppercase hover:underline" <?= $link->attr() ?>>
