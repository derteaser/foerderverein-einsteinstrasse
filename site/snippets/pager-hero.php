  ...
  <div class="relative pt-12 md:pt-0">
    <div class="container px-4 mx-auto">
      <div class="flex flex-col-reverse md:flex-row items-center -mx-4">
        <div class="relative z-10 md:w-1/2 px-4 lg:py-32 mt-6 md:mb-0">
          <div class="flex flex-wrap lg:flex-nowrap">
            <div>
              <h2 class="mb-8 text-4xl lg:text-6xl text-white font-bold font-heading"><?= $section->headline() ?></h2>
