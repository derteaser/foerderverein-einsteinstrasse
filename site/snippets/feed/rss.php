...
?><rss version="2.0" xmlns:content="http://purl.org/rss/1.0/modules/content/" xmlns:wfw="http://wellformedweb.org/CommentAPI/" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:atom="http://www.w3.org/2005/Atom">
  <channel>
    ...
    <?php /** @var ArticlePage $item */ ?>
    <item>
      <title><?= \Kirby\Toolkit\Xml::encode($item->title()) ?></title>
      <link><?= \Kirby\Toolkit\Xml::encode($item->url()) ?></link>
      ...
      <description><![CDATA[<?= $item->intro() ? ('<p>' . $item->intro() . '</p>') : '' ?>
        <?php foreach ($item->text()->toBlocks() as $block): ?>
          <?php snippet('blocks/feed/' . $block->type(), [
            'block' => $block
          ]) ?>
